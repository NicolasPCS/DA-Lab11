...
using Owin;
using APIGoogleAuthentication.Models;
...
namespace APIGoogleAuthentication
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "219736557040-b53b7lu21h82df6b6atsu9j9e049j88t.apps.googleusercontent.com",
                ClientSecret = "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"
            });
        }
    }
}